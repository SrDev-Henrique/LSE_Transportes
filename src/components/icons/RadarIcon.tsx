export const RadarIcon = () => {
  return (
    ...
    >
      <g clipPath="url(#clip0_4418_5860)">
        <path
          opacity="0.4"
        ...
        <path
          opacity="0.4"
          d="M16.7998 15.6004C17.5498 14.6004 17.9998 13.3504 17.9998 12.0004C17.9998 10.6504 17.5498 9.40039 16.7998 8.40039"
          stroke="#fff"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
